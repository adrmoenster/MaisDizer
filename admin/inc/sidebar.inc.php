			...
			<div class="sidebar-content">
					...
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body align-self-center">
                                                            <div class="media-title font-weight-semibold"><?= $userlogin['usuario_nome'];?> <?= Check::Words($userlogin['usuario_sobrenome'],1);?></div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="painel.php?exe=categoria/lista" class="nav-link">
						...
						<li class="nav-item">
							<a href="painel.php?exe=user/lista" class="nav-link">
								<i class="icon-user"></i>
								<span>
									Usuario
								</span>
						...
						<li class="nav-item">
							<a href="painel.php?exe=post/lista" class="nav-link">
